...
<template>
    <div class="pt-6 text-center space-y-4">
      <button
        ...
        class="flex w-full items-start rounded-lg border border-gray-400 bg-white px-5 py-4 text-lg leading-6 font-medium shadow-md hover:shadow-xl transition ease-in-out duration-150"
      >
